...
deleteButton.click(function () {
    ...
    var confirmDelete = confirm("Are you sure you want to decline this appointment?");
    if (confirmDelete) {
        // Send a delete request to the API endpoint
        $.ajax({
            url: "http://localhost:8080/api/v1/appoinment/getappoinment/" + element.id, // Update the API endpoint
            type: "DELETE",
            success: function () {
